...
public class Status {
  ...
  /**
   * Constructor from a proto status.
   * @param proto The proto sattus
   */
  Status(TkrzwRpc.StatusProto proto) {
    code_ = Status.Code.valueOf(proto.getCode());
    message_ = proto.getMessage();
  }
  ...
  /**
   * Sets the code and the message of a proto status.
   * @param proto The proto status.
   */
  void set(TkrzwRpc.StatusProto proto) {
    set(Status.Code.valueOf(proto.getCode()), proto.getMessage());
  }
